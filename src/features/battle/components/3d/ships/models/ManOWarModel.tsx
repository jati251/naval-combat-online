        ...
        return (
          <group key={`mast-${mIdx}`} position={[0, 3.2, mastZ]}>
            ...
            <group position={[0, mastHeight * 0.46, 0]}>
              ...
              <mesh geometry={lowerGeo} position={[0, -length * 0.11 * sailScale, 0.22]} scale={[1, sailScale, 1]} castShadow receiveShadow>
                <meshStandardMaterial map={sailTexture} side={THREE.DoubleSide} roughness={0.85} />
              </mesh>
            </group>
            <group position={[0, mastHeight * 0.83, 0]}>
              ...
              <mesh geometry={upperGeo} position={[0, -length * 0.08 * sailScale, 0.16]} scale={[1, sailScale, 1]} castShadow receiveShadow>
                <meshStandardMaterial map={sailTexture} side={THREE.DoubleSide} roughness={0.85} />
              </mesh>
            </group>
