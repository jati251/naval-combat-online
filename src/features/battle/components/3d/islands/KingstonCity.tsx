...
export const KingstonCity: React.FC<KingstonCityProps> = React.memo(({ settlement, isMobile = false }) => {
  ...
  const mats = useMemo(() => {
    return {
      ...
      brickWall: constructionMaterial('brick', '#9c7158', 4),
      whiteStucco: constructionMaterial('plaster', '#e2dac3', 4),
      timberDeck: constructionMaterial('wood', '#75624c', 4),
      terracottaRoof: constructionMaterial('tile', '#a86e4f', 4),
      slateRoof: constructionMaterial('tile', '#555a55', 4),
